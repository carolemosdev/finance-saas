            ...
            <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border-0 overflow-hidden lg:col-span-2 flex flex-col">
              ...
              <div className="flex-1">
                 ...
                 <div className="md:hidden divide-y divide-slate-100">
                  {transactions.map((t) => (
                    <div key={t.id} className="p-4 flex flex-col gap-3">
                      <div className="flex justify-between items-start">
                        ...
                        <p className="font-extrabold text-emerald-600 text-sm">{formatMoney(t.amount)}</p>
                      </div>
                  ...
                  {transactions.length === 0 && <div className="p-8 text-center text-slate-400 text-sm">Nenhuma receita.</div>}
                </div>
